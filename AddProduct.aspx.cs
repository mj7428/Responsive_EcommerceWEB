...
public partial class AddProduct : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            cmd.Parameters.AddWithValue("@PProductsDetails", txtPDetails.Text);
            ...
            {
                if (ddlSize.Items[i].Selected == true)
                {
                    Int64 SizeID = Convert.ToInt64(ddlSize.Items[i].Value);
                    int Quantity = Convert.ToInt32(txtQuantity.Text);


                    SqlCommand cmd2 = new SqlCommand("insert into tb1ProductsSizeQuantity values('" + PID + "','" + SizeID + "','" + Quantity + "')", con);
            ...
            if (fuImg01.HasFile)
            {
                ...
                SqlCommand cmd3 = new SqlCommand("insert into tb1ProductImages values('" + PID + "','" + txtPName.Text.ToString().Trim() + "01" + "','" + Extention + "')", con);
            ...
            if (fuImg02.HasFile)
            {
                ...
                SqlCommand cmd4 = new SqlCommand("insert into tb1ProductImages values('" + PID + "','" + txtPName.Text.ToString().Trim() + "02" + "','" + Extention + "')", con);
            ...
            if (fuImg03.HasFile)
            {
                ...
                SqlCommand cmd5 = new SqlCommand("insert into tb1ProductImages values('" + PID + "','" + txtPName.Text.ToString().Trim() + "03" + "','" + Extention + "')", con);
            ...
            if (fuImg04.HasFile)
            {
                ...
                SqlCommand cmd6 = new SqlCommand("insert into tb1ProductImages values('" + PID + "','" + txtPName.Text.ToString().Trim() + "04" + "','" + Extention + "')", con);
            ...
            if (fuImg05.HasFile)
            {
                ...
                SqlCommand cmd7 = new SqlCommand("insert into tb1ProductImages values('" + PID + "','" + txtPName.Text.ToString().Trim() + "05" + "','" + Extention + "')", con);
    ...
    protected void ddlGender_SelectedIndexChanged(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(CS))
        {
            SqlCommand cmd = new SqlCommand("select * from tb1Sizes" , con);
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            sda.Fill(dt);
